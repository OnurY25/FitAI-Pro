...
with st.sidebar:
    ...
    st.sidebar.link_button("🚀 Unlock Full Access ($4.99)", "https://onur253515.lemonsqueezy.com/checkout/buy/584006bd-e900-4045-bfb8-214e7e2eb3d7")
    st.divider()
...
with st.container():
    ...
    if st.button("Generate My Professional Plan"):
        if name:
            ...
            WEBHOOK_URL = "https://sciatic-jacinta-nonsecretionary.ngrok-free.dev/webhook/5bcfa3a5-3435-4120-bf18-ad2c6636b8eb"
